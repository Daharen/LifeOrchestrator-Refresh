#!/usr/bin/env python
# FROZEN COPY of the shipped artifact.search 0.1.0 worker (schema_version=1).
# USED ONLY as a fixture to seed a v1 SQLite catalog for the 0.1->0.2 migration test.
# DO NOT EDIT. The live worker is ../artifact_search.py (0.2.0, schema_version=2).
