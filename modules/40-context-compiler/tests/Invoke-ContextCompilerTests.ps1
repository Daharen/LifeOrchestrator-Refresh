...
Write-Host "== context.compile 0.9 entrypoint harness (i38 working-memory hydration; i37 router; i35 artifact_search port) =="
...
Check "skill_version 0.9.0" ($env1.skill_version -eq '0.9.0') "ver=$($env1.skill_version)"
