...
- **Active module:** _none in progress._ **Modules 0–21 complete** (0 executor · 1 `skill.bootstrap` · 2
  ...
  14 `ocr.layout` · 15 `image.util` · 16 `detect.objects` · 17 `image.interpret` · 18 `image.index` · 19 `logic.escalator` · 20 `doc.io` · **21 `agent.local`**), plus **Module 00.1 — Executor Watchdog & Recovery (`exec.watchdog`)** (infrastructure). **The full
