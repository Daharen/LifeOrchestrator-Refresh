...
| #40 context.compiler | **0.3.0 (i31): imports #37's canonical selpol_rrf_v1/1.0.0** -- selpol_reference.py RETIRED (P1-1 one owner, D-0089); params.hard_filter from control_plane.permission_grants; #40's own P0-4 transport budget retained; context_packet/0.2 unchanged (P0-1/P0-3/P0-4/P1-5/A2); 162/162 python (incl #40-vs-direct-select byte-identity) + 34/34 entrypoint + the orchestrator D-0077 selpol fold -Live (real #36; canonical selection, deterministic, 0 orphans) | `b541df6` | 08-03 |
