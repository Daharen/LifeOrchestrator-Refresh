...
`core-docs/FANOUT_ORCHESTRATOR_HANDOFF.md` section 4 (the i35 CONSUMER-WIRING units). Do NOT copy the menu
here -- paste the `orchestrate.fanout` `plan`-emitted worker prompt (or a tight summary pointing to the
