...
- **as_of:** i59 (authored in the i59 close; the live packet epoch is the i59 N7 map/generated commit). If your
  HEAD is past i59, the STAMPED slots (doc count, last-good SHA) may be stale -- identity / SoT / pinned /
...
## PINNED CONSTRAINTS -- 7 as of i59 (never-spill; safety-critical / irreversible -- carried inline so Mode B never drops them)
...
## CANONICAL DOC LIST -- 23 core-docs as of i59 (count-asserted; == `ls core-docs/*.md`; machine-verified at close; N <= K_max=30)
