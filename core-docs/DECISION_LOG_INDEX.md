...
| D-0101 | 2026-08-05 | provisional | Adopt the couriered human-in-the-loop AUDIT-SURFACE / interpretability program (entry vehicle + staged A0-A5 target, both captured VERBATIM in research/): R-1 stage-trace EMISSION binds the i36/i37 router + all future staged filters (D-0077 asserts presence+determinism; zero behavior change); Widget 05 Provenance Map = an i36 coding-lane candidate, Widget 06 Compile Trace Console i37-i38, Phase 2 possession/side-by-side post-i40 red-team-gated; PB-2 delegation-event tie-in + NEW PB-4 cadence; target promotes to core-docs/AUDIT_PIPELINE.md at A1. Non-displacing (readers over existing mandated artifacts). |
| D-0102 | 2026-08-05 | locked | i36 CLOSED: TIER-1 ACCEPTED -- the orchestrator ran the FULL wired-descend rehearsal gate (harness #37 0.8.0 x FROZEN #40 0.7.0) over a DISTINCT hash-verified 6-package foreign corpus at a 100x leaf span -> 11/11 s10 criteria, 0 fold reconciliation -> project tier1_accepted FLIPPED TRUE (honest caveat: descend fast-beam lossy, the #36-flat fallback preserves recall -- a follow-on). 3-lane wave (`fo-36-1a676e4b`): #37 eval 0.8.0 (`0e466bc`) + #36 0.6.0 get-record (`16c27a8`) + NEW widgets/05 Provenance Map (`3ad71d3`, audit A1). Action-authz freeze design captured (frontier CONDITIONAL-GO). i34 smoke 38/38. |
...
| D-0109 | 2026-08-06 | locked | i39 frontier as-built RE-REVIEW (pack b2b1e5fb) returned FAIL -- p0_1_gate_status WALKED BACK to incomplete (over-claimed, like D-0107); build_complete + activation prohibited UNCHANGED, deny-by-default holds (fold-i39 18/18 + independent 308/308); 7 suite-build findings -> i40 unit-0 (research/2026-08-06-i39-p01gate-recheck-redteam.md) [supersedes the D-0108 pass claim] |
| D-0110 | 2026-08-06 | locked | i40 sunset: mandate-01 report (verdict NO) -> mandate 02 LICENSED in place (sunset i47; PB-1 gate deadline i42; verify-before-ratify structural; PB-2 boundary = M2-E) |
| D-0111 | 2026-08-06 | locked | i40 wave open (fo-40-d42fd1ac, 2-lane CPU): #43 the 7 D-0109 exact closures (worker may NOT claim pass -- M2-D) + #37 PB-5 reconcile; slots 002/003 READY; s7 re-ratification gated on the frontier re-review PASS |
| D-0112 | 2026-08-06 | locked | i40 close (fo-40-d42fd1ac): #43 0.4.0 the 7 D-0109 exact closures (ORCHESTRATOR-RECOVERED ship after a pre-push bridge death; M2-D held -- gate stays incomplete) + #37 0.8.1 (PB-5 CLOSED); fold green; round-3 ratification pack 5807bc3e couriered -- s7 flips ONLY on its PASS |
| D-0113 | 2026-08-06 | locked | i40 round-3 ratification review (pack 5807bc3e) FAIL -- s7 NOT ratified; F3/F6 accepted closed + F2/F4 partial, 5 suite-build findings remain (PermitStore write-once / consumed TargetHandle / lossless 0.9.0 adapter / top-level GrantView enforcement / complete pack transport) -> the i41 #43 unit; M2-D held (no over-claim to walk back) |
