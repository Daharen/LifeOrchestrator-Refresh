...
| D-0100 | 2026-08-05 | locked | i35 CLOSED: consumer wiring (#40 0.7.0 public hierarchy_port + #37 0.7.0 the Tier-1 rehearsal harness); D-0077 fold passed; tier1_accepted deferred to i36; P0-1 injection-suite red-team NO-GO without a deny-by-default monitor |
...
| D-0104 | 2026-08-05 | locked | i37 CLOSED: safety+router wave (#40 0.8.0 query ROUTER + NEW #43 action.authz P0-1 suite MVP 192/192); D-0077 fold 13/13 + i34 38/38; freeze red-team GO-WITH-AMENDMENTS (7 i38 amendments; build_complete, gate incomplete) |
