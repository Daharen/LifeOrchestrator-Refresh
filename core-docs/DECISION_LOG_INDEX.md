...
| D-0126 | 2026-08-08 | provisional | interpretability POSER decision (Nicholas): UNGATED read-only info-only '?' -> local-9B explain + follow-ups; ungate-able via the info-only invariant; rides gateway/lease, fail-silent; legibility = his signal not a gate [built = D-0127] |
| D-0127 | 2026-08-08 | locked | LRAP POSER SHIPPED (D-0126): widgets/08 `9f99495` -- per-element '?' -> local-9B explain + follow-ups; ungated, read-only held + fail-silent; cloud 104/0/3 + Win -Live 119/0/0; next = front-step/ride-along/output |
