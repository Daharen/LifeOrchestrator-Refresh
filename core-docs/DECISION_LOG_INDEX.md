...
| D-0082 | 2026-08-01 | locked | Fan-out iteration 25 (WAVE 1, 3-lane fo-25-3b718a13): the Collective Agent memory substrate SHIPPED -- #35 embedding.local 0.1.0 (99b6590; wires embedding.qwen3-0p6b dim 1024; defines the embedding-provider interface; 42/42) + #36 artifact.search 0.1.0 (30ef7bd; SQLite catalog + FTS5 lexical + provenance + reconcile + mock/real embedding seam; produces the retriever interface; 69/69) + #37 retrieval.eval 0.1.0 (687edcd; benchmark + BM25-lite + recall@K/MRR/stale/provenance; consumes the retriever interface; 69/69). D-0077 cross-module smoke PASSED (real 1024-dim embed->store->search->benchmark; recall/provenance 1.0; digest stable; change detected; 0 orphans) -- caught + bridged a span object-vs-string producer/consumer divergence. Memory red-team 12c8f539 folded: GATE=GO, conditional on a retrieval-record/provenance contract amendment (digest research/2026-08-01-frontier-memory-redteam.md). embedding.qwen3-0p6b wired. Slots archived+reset. NEXT = contract freeze -> Wave 2. |
