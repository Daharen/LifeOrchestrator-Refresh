...
4. **Generators, cheapest-first:** `gen.audio` (**MVP COMPLETE 2026-07-25, D-0033**) → `gen.image` (**MVP COMPLETE 2026-07-25, D-0034**; SD 1.5 via diffusers) → `gen.music` → `gen.video`.
