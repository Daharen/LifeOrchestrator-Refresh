...
4. **Generators, cheapest-first:** `gen.audio` (**MVP COMPLETE 2026-07-25, D-0033**) → `gen.image` (**MVP COMPLETE 2026-07-25, D-0034**; SD 1.5 via diffusers) → `gen.music` (**MVP COMPLETE 2026-07-26, D-0035**; MusicGen Small via transformers) → `gen.video`.
