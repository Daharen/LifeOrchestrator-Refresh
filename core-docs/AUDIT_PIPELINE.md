...
- `review_due: i54` (NICHOLAS OVERRIDE, D-0137 -- the +4/+5 formula + the s5 bump rule are suspended for this cycle by direction; i54 co-schedules this review with the SEALED_CHECK_47 opening (i>=54) so process review lands in one checkpoint; the w08 explain-window-close defect (D-0134) still rides ANY earlier w08 touch)
