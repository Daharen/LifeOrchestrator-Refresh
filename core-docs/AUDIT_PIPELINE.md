...
- `last_reviewed: i54` (D-0147 -- the i54 co-scheduled review ran: review_due reached, no tier-prereq flip since i45 (A3 remains designable, prereqs met), next_increment unchanged)
- `review_due: i56` (bumped +2 at i54, D-0147 -- s5 no-spare-lane bump: the i54 wave focused on the SEALED_CHECK_47 outcome + PB-7 token-endurance scoping, so no audit coding lane was spare; co-schedules the next audit review with the SP3 re-run; the w08 explain-window-close defect (D-0134) still rides ANY earlier w08 touch)
