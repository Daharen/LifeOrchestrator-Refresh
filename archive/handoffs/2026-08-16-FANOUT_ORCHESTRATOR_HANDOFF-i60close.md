...
- **i59 CLOSED (D-0154): the ROOT front-door migration SHIPPED** -- START_HERE boot KERNEL + `COLD_BOOT_CARD.md` (generator-independent survivor) + `ops/frontdoor/` uniform rebuild interface + the migration gate; 3-adversary red-teamed (frozen `research/2026-08-15-i59-root-migration-{hardened,redteam}.md`). **i59 also RECONCILED (D-0155): NEXT = i60 = bounded-ingest + control-plane hardening** -- prove/ENFORCE the bootstrap, close F-i53-eff, repair FO-6, a bounded manager view; the first CLASS migration DEFERS to i68. Rolling i60-i79: `research/2026-08-15-i59-roadmap-reconciliation.md`. AUDIT review_due i62. Seat = Fable 5 until Nicholas declares settled (D-0134).
...
## 4. Current frontier -- i59 CLOSED (D-0154) + RECONCILED (D-0155): NEXT = i60 = bounded-ingest + control-plane hardening; AUDIT review_due i62; SP3/M-03 open (i60 INVESTIGATES, does NOT license)
