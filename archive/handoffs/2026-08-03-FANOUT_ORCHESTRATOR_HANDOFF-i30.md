...
- Read section 2 (orient + verify the box), then run **iteration 31** (SELECTION-POLICY SETTLE -- section 4). i30 CONTRACT-HARDENING is DONE (D-0087 contract + D-0088 conformance; #40 0.2.0 / #37 0.3.0 / #41 0.2.0); the D-0077 fold caught a selpol producer/consumer divergence to settle at i31. Iterations 1-28 are DONE +
...
## 4. Current frontier -- i30 CONTRACT-HARDENING DONE (D-0087/D-0088); NEXT = i31 SELECTION-POLICY SETTLE
...
## 11. Box state at handoff (2026-08-03, D-0088 -- i30 CONTRACT-HARDENING done)
