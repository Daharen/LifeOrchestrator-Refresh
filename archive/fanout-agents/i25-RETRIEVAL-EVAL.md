...
DONE `687edcd`. retrieval.eval 0.1.0; benchmark schema + BM25-lite baseline + external_command seam; recall@K/MRR/stale/provenance; canonical JSON+MD byte-identical; 69/69 cloud + 69/69 -Live.
