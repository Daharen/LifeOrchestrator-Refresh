...
DONE `30ef7bd`. artifact.search 0.1.0; SQLite catalog + FTS5; ingest/search/embed(mock)/integrity/catalog/export-chunk-texts/store-embeddings; 69/69 cloud + 69/69 -Live; deterministic re-ingest + reconcile + integrity + provenance; both D-0077 interfaces in SCHEMA_NOTES.
